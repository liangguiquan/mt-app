    ...
    <div class="footer-content">
      <div class="footer-link clearfix">
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/useragree"
                target="_blank"
              >用户协议</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/privacy"
                target="_blank"
              >隐私政策</a>
            </dd>
            <dd>
        ...
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a href="https://kd.meituan.com/" target="_blank">美团外卖开店申请</a>
            </dd>
            <dd>
              <a
            ...
            <dd>
              <a href="https://xue.meituan.com/?from=mtpc" target="_blank">美团点评餐饮学院</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="http://ruzhu.meituan.com/ruzhu/index.html"
                target="_blank"
              >酒店商家入驻</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://i.meituan.com/awp/h5/trip/business/cooperation/index.html?client=pc"
                target="_blank"
              >境内度假商家入驻</a>
            </dd>
            <dd>
            ...
            <dd>
              <a rel="nofollow" href="https://phoenix.meituan.com/about/" target="_blank">榛果民宿房东商家入驻</a>
            </dd>
            <dd>
            ...
            <dd>
              <a rel="nofollow" href="http://developer.meituan.com/" target="_blank">聚宝盆餐饮开放平台</a>
            </dd>
            <dd>
              <a rel="nofollow" href="http://smartpay.meituan.com/" target="_blank">美团智能支付</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
            ...
            <dd>
              <a rel="nofollow" href="https://shangou.meituan.com/joinin" target="_blank">美团闪购商家入驻</a>
            </dd>
          </dl>
        </div>
        <div class="footer-column">
          <dl>
            ...
            <dd>
              <a rel="nofollow" href="http://union.meituan.com/" target="_blank">美团联盟</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://store.meituan.com/distribution/broadcast"
                target="_blank"
              >美团收银招募线上分销商</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://agent.meituan.com/zhaoshang?entry=5"
                target="_blank"
              >美团点评5S服务商招募</a>
            </dd>
          </dl>
          <dl>
            ...
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/foodsafe"
                target="_blank"
              >美团点评餐饮安全管理办法</a>
            </dd>
          </dl>
          <dl>
            <dt>廉正举报</dt>
            <dd>
              <a rel="nofollow" href="mailto:lianzheng@meituan.com" target="_self">廉政邮箱</a>
            </dd>
          </dl>
        </div>
        <div class="footer-column">
          <dl>
            <dt>关注美团</dt>
            <dd>
              <a rel="nofollow" href="http://weibo.com/meituan" target="_blank">美团新浪微博</a>
            </dd>
          </dl>
          <dl>
            <dt>公司信息</dt>
            ...
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/law"
                target="_blank"
              >法律声明</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/comment/price"
                target="_blank"
              >价格说明</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/comment/judge"
                target="_blank"
              >美团网平台点评规则</a>
            </dd>
            <dd>
              <a
                rel="nofollow"
                href="https://portal-portm.meituan.com/webpc/protocolmanage/comment"
                target="_blank"
              >美团点评团购用户服务条款</a>
            </dd>
            <dd>
      ...
      <div class="footer-copyright clearfix">
        <div class="footer-copyright-left">
          ...
          <p>
            <a
              href="https://portal-portm.meituan.com/webpc/protocolmanage/comment/license/tv"
              target="_blank"
            >广播电视节目制作经营许可证（京）字第03889号</a>
          </p>
          <p>
            <a
              href="https://portal-portm.meituan.com/webpc/protocolmanage/foodlicense"
              target="_blank"
            >食品经营许可证</a>
            <a
          ...
          <p>
            <a
              href="http://portal-portm.meituan.com/webpc/protocolmanage/medicalapparatus"
              target="_blank"
        ...
        <div class="footer-copyright-right">
          ...
          <div class="footer-copyright-cert">
            <a
              ...
              href="https://portal-portm.meituan.com/webpc/protocolmanage/comment/license/sankuai"
              title="备案信息"
              target="_blank"
            >备案信息</a>
            <a
